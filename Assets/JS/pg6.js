...
function showNews(index) {
  ...
  document.getElementById("newsLink").onclick = function () {
    document.getElementById("modalTitle").textContent = news[index].title;

    document.getElementById("modalImage").src = news[index].image;

    document.getElementById("modalText").textContent = news[index].description;
  };
}
showNews(0);
